...
export const adminDoctorSchedulesColumns: ColumnDef<IDoctorSchedule>[] = [
  {
    id: "doctor",
    header: "Doctor",
    enableSorting: false,
    cell: ({ row }) => {
      ...
      return (
        <div className="flex flex-col">
          <span className="text-sm font-medium">{doctor.name ?? "N/A"}</span>
          <span className="text-xs text-muted-foreground">{doctor.email ?? "N/A"}</span>
        </div>
      )
    },
  },
